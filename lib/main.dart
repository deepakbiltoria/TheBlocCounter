...
class _CounterAppState extends State<CounterApp> with WidgetsBindingObserver {
  ...
  void initState() {
    WidgetsBinding.instance.addObserver(
        this); // its an observer that watch for change in system properties value
    super.initState();
  }
  ...
  void didChangePlatformBrightness() {
    context
        .read<ThemeCubit>()
        .updateAppTheme(); // this updates apptheme when the system value of Brightnes mode changes
